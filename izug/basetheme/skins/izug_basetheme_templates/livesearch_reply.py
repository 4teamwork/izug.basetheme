...
if not results:
    ...
    write('''<legend id="livesearchLegend">%s</legend>''' % context.translate(legend_livesearch, domain="izug.basetheme"))
    write('''<div class="LSIEFix">''')
    write('''<div id="LSNothingFound">%s</div>''' % context.translate(label_no_results_found, domain="izug.basetheme"))
