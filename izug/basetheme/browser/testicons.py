...
ALL_CONTENT_TYPES = {             
            ...
            'contenttype-blog-entry': 'Fokuseintrag',
            'contenttype-blog': 'Fokus',
            'contenttype-content-page': 'Inhaltsseite',
            'contenttype-event': 'Veranstaltung',
            'contenttype-favorite': 'Lesezeichen',
            'contenttype-file': 'Datei, Dokument, Shopitem',
            'contenttype-folder': 'Folder',
            'contenttype-ftw-mail-mail': 'E-Mail, Nachricht',
            'contenttype-htmlblock': 'HTML Block',
            'contenttype-image': 'Image',
            'contenttype-kita': 'Kita',
            'contenttype-lebenslage': 'Thema',
            'contenttype-link': 'Link',
            'contenttype-mitglied': 'Mitglied',
            'contenttype-news': 'Aktuell, News, Medienmitteilung',
            'contenttype-opengever-contact-contact': 'Kontakt',
            'contenttype-opengever-dossier-businesscasedossier': 'Dossier',
            'contenttype-opengever-inbox-forwarding': 'Weiterleitung',
            'contenttype-opengever-inbox-inbox': 'Eingangskorb',
            'contenttype-opengever-repository-repositoryfolder': 'Ordnungsposition',
            'contenttype-opengever-repository-repositoryroot': 'Ordnungssystem',
            'contenttype-opengever-task-task': 'Aufgabe',
            'contenttype-opengever-tasktemplates-tasktemplate': 'Standardablauf',
            'contenttype-orgunit': 'Organisationseinheit',
            'contenttype-refegovservice': 'Service',
            'contenttype-remark': 'Kommentar',
            'contenttype-subsite': 'Integrationstyp A, B, C oder D',
            'contenttype-zugnewsletter': 'Newsletter',
            'contenttype-arbeitsraum': 'Arbeitsraum',
            'contenttype-billboardad': 'Anschlagbrett',
            'contenttype-buch': 'Buch',
            'contenttype-buchblock': 'BuchBlock',
            'contenttype-egovform': 'Formular',
            'contenttype-kapitel': 'Kapitel',
            'contenttype-meeting': 'Termin',
            'contenttype-meetingitem': 'Traktandum',
